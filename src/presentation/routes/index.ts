...
router.use("/prospects", requireAuth, requirePermission("SCOUTING", "VIEW"), prospectRoutes);
router.use("/combine-scores", requireAuth, requirePermission("SCOUTING", "VIEW"), combineScoreRoutes);
